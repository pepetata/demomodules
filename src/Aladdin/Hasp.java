...
public class Hasp {
    ...
    private static native byte[] Detach(String action, String scope, String vendor_code, String destination,
            int status[]);

    private static native byte[] Transfer(String action, String scope, String vendor_code, String destination,
            int status[]);
