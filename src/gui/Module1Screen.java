...
public class Module1Screen implements ActionListener {
    ...
    public Module1Screen(Locale lang, boolean isAppProtected, boolean custom, Features demoFeature) throws Error {
    ...
    private void prepareGUI() throws Error {
        ...
        p1.setBackground(bg);
        Label l1 = new Label(custom ? f1100.getFeatureName() : bundle.getString("module1.title2"));
